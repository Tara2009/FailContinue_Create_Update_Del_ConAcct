...
Entering a Contacts
    ...
    TypeText           First Name                  Pleasehelp_3
    TypeText           Last Name                   Helptocreate_4
...
Delete the Record from Contact
    ...
    ClickText          Contacts
    ClickText          All Contacts
    TypeText           Search this list...         Deletion\n
    ClickText          Deletion For Selected Record
    ClickText          Details
